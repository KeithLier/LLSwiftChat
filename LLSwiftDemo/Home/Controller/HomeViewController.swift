...
class HomeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.chats = [
            ...
            ["name":"湖景涛","content":"[视频]","image":"2","time":"16/7/29"],
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell:HomeTableViewCell! = tableView.dequeueReusableCellWithIdentifier("HomeCell", forIndexPath: indexPath) as! HomeTableViewCell
        let dict:NSDictionary! = self.chats[indexPath.row] as! NSDictionary
        cell.name.text = dict["name"] as? String
        cell.detail.text = dict["content"] as? String
        cell.time.text = dict["time"] as? String
